...
from ..llm.lora_llm import build_llama
...
class TransformersLlamaHandler(BaseHandler, ABC):
    ...
    def initialize(self, ctx):
        ...
        cfg = LlamaConfig.build_llama_config(properties.get("model_config"), properties.get("generation_config"), properties.get("adapter"), self.device)
